...
export const VIDEOGAMES: Videogame[] = [
	{
		...
		image:'https://i.imgur.com/AlcJxXI.png',
	...
	},
	{
		_id: 2,
		title:'God of War',
		description: "God of War is an action-adventure game franchise created by David Jaffe at Sony's Santa Monica Studio. It began in 2005 on the PlayStation 2 (PS2) video game console, and has become a flagship title for the PlayStation brand, consisting of eight fully fledged games across multiple platforms, as well as a text-based game, with another full game to be released in November 2022. Based in ancient mythologies, the story follows the titular protagonist, Kratos, a Spartan warrior and later the Greek God of War, who was tricked into killing his family by his former master, the original Greek God of War Ares. This sets off a series of events that leads to wars with the different mythological pantheons. The Greek era of the series sees Kratos follow a path of vengeance due to the machinations of the Olympian gods, while the Norse era, which introduces his son Atreus as a secondary protagonist, shows an older Kratos on a path of redemption, which inadvertently brings the two into conflict with the Norse gods and the pair trying to prevent Ragnarök.'",
		image:'https://i.imgur.com/455Hs1b.jpg',
	...
	},
	{
		_id: 6,
		title:'Titanfall',
		description: 'Titanfall, the first game in the series, was released for Xbox One and Microsoft Windows on March 11, 2014. On April 8, 2014 it released for Xbox 360. The game was mainly multiplayer focused with no real single-player campaign included. Instead, there was a single-player tutorial included that served as a way for the player to learn the mechanics of the game.',
    image:'https://i.imgur.com/W95YcKu.jpg',
	...
	},
	{
		...
		description: 'Forza Horizon 4 è un videogioco open world di guida, sviluppato in esclusiva per Xbox One e Windows 10 da Playground Games utilizzando il motore grafico ForzaTech dei Turn 10 Studios, è stato pubblicato il 2 ottobre 2018[1]. Il 10 novembre 2020 è uscita una versione potenziata del gioco per Xbox Series X/S.',
    image:'https://i.imgur.com/Fet77s0.jpg',
	...
	},
	{
		...
		image:'https://i.imgur.com/yMFUMqt.jpg',
	...
	},
	{
		_id: 11,
		title:'Chivalry 2',
		description: 'Chivalry 2 is a 2021 multiplayer hack and slash action video game developed by Torn Banner Studios and published by Tripwire Interactive. The sequel to Chivalry: Medieval Warfare (2012), the game was released on June 8, 2021 for Windows, PlayStation 4, PlayStation 5, Xbox One and Xbox Series X and Series S.',
		image:'https://i.imgur.com/KJWZRc3.jpg',
    image1:'https://i.imgur.com/ECoq166.jpg',
    image2:'https://i.imgur.com/UG2IvtP.jpg',
		data:'03/11/2022',
		platform:'Pc',
		published:true
	},
	{
		...
		description: "'Baldur's Gate III is an upcoming role-playing video game that is being developed and published by Larian Studios. It is the third main game in the Baldur's Gate series, which is itself based on the Dungeons & Dragons tabletop role-playing system.[1] A partial version of the game was released in early access format for Microsoft Windows, macOS, and the Stadia streaming service, on 6 October 2020. The game is expected to remain in early access until 2023. The full version of the game will not be released on Stadia due to the service's closure.'",
    image:'https://i.imgur.com/QEv4YLx.jpg',
    image1:'https://i.imgur.com/LiLzTVl.jpg',
    image2:'https://i.imgur.com/8MIHbeo.jpg',
		data:'03/11/2022',
		platform:'Pc',
		published:true
	},
    ...
    image:'https://i.imgur.com/wW2i6UZ.png',
    image1:'https://i.imgur.com/OMKEjhM.jpg',
    image2:'https://i.imgur.com/V7rGmtr.jpg',
		data:'03/11/2022',
		platform:'Pc',
		published:true
	},
	{
		_id: 15,
		title:'Factorio',
		description: 'Factorio is a construction and management simulation game developed by the Czech studio Wube Software. The game was announced via an Indiegogo crowdfunding campaign in 2013 and released for Windows, macOS, and Linux on 14 August 2020 following a four-year long early access phase. The game was released on Nintendo Switch on 28 October 2022',
		image:'https://i.imgur.com/Z020IoY.png',
    image1:'https://i.imgur.com/Jcmp6oG.jpg',
    image2:'https://i.imgur.com/lB5nvTO.jpg',
		data:'03/11/2022',
		platform:'Pc',
		published:true
	},
	{
		_id: 16,
		title:'Bayonetta 3',
		description: 'Bayonetta 3[a] is an action-adventure game developed by PlatinumGames and published by Nintendo for the Nintendo Switch. It was directed by Yusuke Miyata and produced by Yuji Nakao, with the Bayonetta creator Hideki Kamiya as supervising director. It was announced in December 2017, and was released on October 28, 2022.[1][2] The game follows the titular angel-hunting witch Bayonetta, who must face against man-made bioweapons called Homunculi, and an entity known as the Singularity which threatens to destroy the multiverse. She is assisted by an ensemble of characters, including a coven of alternate universe versions of herself; and a new witch-in-training named Viola.',
    image:'https://i.imgur.com/xsJmFj5.jpg',
    image1:'https://i.imgur.com/EelZfd6.jpg',
    image2:'https://i.imgur.com/4JR8eYj.jpg',
		data:'04/11/2022',
		platform:'Switch',
		published:true
	},
	{
		_id: 17,
		title:'Mario Kart 8',
		description: 'Mario Kart 8[b] is a kart racing video game developed and published by Nintendo for the Wii U in May 2014. It retains Mario Kart series game mechanics, where players control Mario franchise characters in kart racing, collecting a variety of items to hinder opponents or gain advantages in the race. Mario Kart 8 introduces anti-gravity driving on walls or ceilings, and allows players to bump into each other for a short boost. It has single-player and multiplayer modes, including online via the Nintendo Network.',
    image:'https://i.imgur.com/nimhG9m.jpg',
    image1:'https://i.imgur.com/Kwg1xQ6.jpg',
    image2:'https://i.imgur.com/nimhG9m.jpg',
		data:'04/11/2022',
		platform:'Switch',
		published:true
	},
	{
		...
		description: "'In Odyssey, Mario explores various kingdoms and collects Power Moons hidden inside them, used as a fuel source to power an airship known as the Odyssey to travel to new locations. Cappy's main function is the capture ability, letting Mario possess enemies and other objects, helping him solve puzzles and progress in the game. After completing the main story mode, other post-game kingdoms are unlockable and an additional minigame, Luigi's Balloon World, is playable. The game supports multiplayer and virtual reality with a Nintendo Labo virtual reality kit.)'",
    image:'https://i.imgur.com/MSgeo4H.jpg',
    image1:'https://i.imgur.com/LQQpS5V.jpg',
    image2:'https://i.imgur.com/1uGU4V2.jpg',
		data:'04/11/2022',
		platform:'Switch',
		published:true
	},
	{
		...
		description: 'The Legend of Zelda: Breath of the Wild[b] is a 2017 action-adventure game developed and published by Nintendo for the Nintendo Switch and Wii U consoles. The game is an installment of The Legend of Zelda series and is set at the end of its timeline. The player controls an amnesiac Link, who awakens from a hundred-year slumber, and attempts to regain his memories and prevent the destruction of Hyrule by Calamity Ganon.',
    image:'https://i.imgur.com/VunvZDG.jpg',
    image1:'https://i.imgur.com/g6wAIdT.jpg',
    image2:'https://i.imgur.com/VvYRvBb.jpg',
		data:'04/11/2022',
		platform:'Switch',
		published:true
	},
	{
		...
		description: 'Animal Crossing: New Horizons[b] is a 2020 social simulation game developed and published by Nintendo for the Nintendo Switch; it is the fifth main entry in the Animal Crossing series. In New Horizons, the player controls a character who moves to a deserted island after purchasing a getaway package from Tom Nook, accomplishes assigned tasks, and develops the island as they choose. They can gather and craft items, customize the island, and develop it into a community of anthropomorphic animals.)',
    image:'https://i.imgur.com/eGpcBga.jpg',
    image1:'https://i.imgur.com/nBj331U.jpg',
    image2:'https://i.imgur.com/BX9XMXL.jpg',
		data:'04/11/2022',
		platform:'Switch',
		published:true
	}
